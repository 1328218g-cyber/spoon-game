...
function defaultSettings() {
  return {
    ...
    moduleEnabled: {
      ...
      migrate: true, lottoauto: false, reactiontimer: false, dday: false, raffle: false, dice: false, soundfx: false, // ※ 새로 추가되는 모듈은 기본 OFF — 유저가 모듈 마켓에서 직접 찾아 켜야 함
    },
    ...
    moduleVisible: {
      ...
      flag: true, shield: true, request: true, roulette: true,
      roulettelog: true, autogrant: true, loyalty: true, quiz: true, botreboot: true,
      migrate: true, lottoauto: true, reactiontimer: true, dday: true, raffle: true, dice: true, soundfx: true,
    },
